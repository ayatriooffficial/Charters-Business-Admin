              ...
              >
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 5 }}>
                    <span style={{ fontSize: 14, fontWeight: 700, color: 'var(--text-primary)' }}>Job Status</span>
                    <span
                      style={{
                        fontSize: 12,
                        fontWeight: 700,
                  ...
                  <p style={{ margin: 0, fontSize: 13, color: 'var(--text-secondary)' }}>
                    {formData.isActive
                      ? 'This job is live and visible to applicants.'
                      : 'This job is hidden from applicants until reactivated.'}
                  </p>
                </div>
